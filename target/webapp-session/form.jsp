...
<form action="${pageContext.request.contextPath}/productos/form" method="post">
    ...
    <div class="row mb-2">
        ...
        <c:if test="${errores != null && !empty errores.containsKey('precio')}">
    ...
    <div class="row mb-2">
        ...
        <c:if test="${errores != null && !empty errores.containsKey('sku')}">
    ...
    <div class="row mb-2">
        ...
        <c:if test="${errores != null && !empty errores.containsKey('fecha_registro')}">
    ...
    <div class="row mb-2">
        ...
        <c:if test="${errores != null &&  !empty errores.containsKey('categoria')}">
    ...
    <div class="row mb-2">
        ...
        <input hidden="hidden" name="id" value="${producto.id}">
</form>
